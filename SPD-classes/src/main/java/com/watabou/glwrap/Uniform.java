...
public class Uniform {
	...
	// Cached values to skip redundant GL uniform uploads
	private float cached1f = Float.NaN;
	private float cached4f_v1 = Float.NaN;
	private float cached4f_v2 = Float.NaN;
	private float cached4f_v3 = Float.NaN;
	private float cached4f_v4 = Float.NaN;
	...
	public void value4f(float v1, float v2, float v3, float v4) {
		if (v1 != cached4f_v1 || v2 != cached4f_v2 || v3 != cached4f_v3 || v4 != cached4f_v4) {
			cached4f_v1 = v1;
			cached4f_v2 = v2;
			cached4f_v3 = v3;
			cached4f_v4 = v4;
