...
public class Quad {
	...
	//Invalidates the GL index buffer handle after WebGL context loss.
	//The old buffer ID is no longer valid, so we reset to -1
	//to force setupIndices() to generate a new one.
