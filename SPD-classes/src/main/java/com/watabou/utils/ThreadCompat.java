...
/**
 * Thread and synchronization compatibility layer.
 * On standard JVM, delegates to real threading primitives.
 * On GWT (via super-source), these are no-ops since JS is single-threaded.
 */
