...
import com.sacredpixel.sacredpixeldungeon.items.remains.RemainsItem;
...
public class Badges {
	...
	/**
	 * Clears all global badges (used for data import overwrite).
	 * Does not save to file - caller must call saveGlobal() after populating new badges.
	 */
