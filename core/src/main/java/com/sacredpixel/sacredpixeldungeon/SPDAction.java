...
public class SPDAction extends GameAction {
	...
	// Combat & Tags (ordered: attack, action, loot, resume, cycle)
	...
	// UI Focus Navigation
	public static final GameAction FOCUS_UP     = new SPDAction("focus_up");
	public static final GameAction FOCUS_DOWN   = new SPDAction("focus_down");
	public static final GameAction FOCUS_LEFT   = new SPDAction("focus_left");
	public static final GameAction FOCUS_RIGHT  = new SPDAction("focus_right");
	...
	public static final GameAction CAMERA_UP         = new SPDAction("camera_up");
	public static final GameAction CAMERA_LEFT       = new SPDAction("camera_left");
	public static final GameAction CAMERA_DOWN       = new SPDAction("camera_down");
	public static final GameAction CAMERA_RIGHT      = new SPDAction("camera_right");

	// Camera diagonal
	public static final GameAction CAMERA_UP_LEFT    = new SPDAction("camera_up_left");
	public static final GameAction CAMERA_UP_RIGHT   = new SPDAction("camera_up_right");
	public static final GameAction CAMERA_DOWN_LEFT  = new SPDAction("camera_down_left");
	public static final GameAction CAMERA_DOWN_RIGHT = new SPDAction("camera_down_right");
	public static final GameAction CAMERA_HERO       = new SPDAction("camera_hero");
	...
	static {
		...
		defaultBindings.put( Input.Keys.NUMPAD_DOT,     SPDAction.BACK );
		...
		defaultBindings.put( Input.Keys.S,              SPDAction.WAIT_OR_PICKUP );
		defaultBindings.put( Input.Keys.NUMPAD_5,       SPDAction.WAIT_OR_PICKUP );

		// Inventory & Bags
		defaultBindings.put( Input.Keys.NUM_7,          SPDAction.INVENTORY );
		defaultBindings.put( Input.Keys.APOSTROPHE,     SPDAction.INVENTORY );
		defaultBindings.put( Input.Keys.NUM_8,          SPDAction.BAG_1 );
		defaultBindings.put( Input.Keys.NUM_9,          SPDAction.BAG_2 );
		defaultBindings.put( Input.Keys.NUM_0,          SPDAction.BAG_3 );
		defaultBindings.put( Input.Keys.MINUS,          SPDAction.BAG_4 );
		defaultBindings.put( Input.Keys.EQUALS,         SPDAction.BAG_5 );

		// Examine, Wait & Rest
		defaultBindings.put( Input.Keys.R,              SPDAction.EXAMINE );
		defaultBindings.put( Input.Keys.T,              SPDAction.WAIT );
		defaultBindings.put( Input.Keys.Y,              SPDAction.REST );

		// Combat & Tags
		defaultBindings.put( Input.Keys.V,              SPDAction.TAG_LOOT );
		defaultBindings.put( Input.Keys.F,              SPDAction.TAG_ATTACK );
		defaultBindings.put( Input.Keys.G,              SPDAction.TAG_ACTION );
		defaultBindings.put( Input.Keys.GRAVE,           SPDAction.TAG_RESUME );
		defaultBindings.put( Input.Keys.SPACE,          SPDAction.CYCLE );
		defaultBindings.put( Input.Keys.NUMPAD_0,       SPDAction.CYCLE );
		...
		// Arrow keys as 3rd binding for movement (N/W/S/E)
		...
		// Zoom
		defaultBindings.put( Input.Keys.RIGHT_BRACKET,  SPDAction.ZOOM_IN );
		defaultBindings.put( Input.Keys.LEFT_BRACKET,   SPDAction.ZOOM_OUT );

		// Camera
		defaultBindings.put( Input.Keys.O,              SPDAction.CAMERA_UP );
		defaultBindings.put( Input.Keys.K,              SPDAction.CAMERA_LEFT );
		defaultBindings.put( Input.Keys.PERIOD,         SPDAction.CAMERA_DOWN );
		defaultBindings.put( Input.Keys.SEMICOLON,      SPDAction.CAMERA_RIGHT );
		defaultBindings.put( Input.Keys.I,              SPDAction.CAMERA_UP_LEFT );
		defaultBindings.put( Input.Keys.P,              SPDAction.CAMERA_UP_RIGHT );
		defaultBindings.put( Input.Keys.COMMA,          SPDAction.CAMERA_DOWN_LEFT );
		defaultBindings.put( Input.Keys.SLASH,          SPDAction.CAMERA_DOWN_RIGHT );
		defaultBindings.put( Input.Keys.L,              SPDAction.CAMERA_HERO );
	}
	...
	static {
		...
		KeyBindings.addHardBinding( Input.Keys.NUMPAD_ENTER, SPDAction.NONE );
	}
