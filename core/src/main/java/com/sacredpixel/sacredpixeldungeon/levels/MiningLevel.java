...
import com.sacredpixel.sacredpixeldungeon.actors.mobs.FungalSpinner;
...
import com.sacredpixel.sacredpixeldungeon.levels.painters.MiningLevelPainter;
...
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MineEntrance;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MineGiantRoom;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MineLargeRoom;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MineSecretRoom;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MineSmallRoom;
...
import com.sacredpixel.sacredpixeldungeon.sprites.BlacksmithSprite;
...
public class MiningLevel extends CavesLevel {
	...
	protected Builder builder() {
		return new LoopBuilder().setPathLength(0.5f, new float[]{1}).setTunnelLength(new float[]{1}, new float[]{1});
	}
