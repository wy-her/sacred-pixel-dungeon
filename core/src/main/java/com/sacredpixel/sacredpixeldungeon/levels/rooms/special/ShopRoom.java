...
package com.sacredpixel.sacredpixeldungeon.levels.rooms.special;
...
public class ShopRoom extends SpecialRoom {
	...
	protected void placeItems( Level level ){
		...
		if (!itemsToSpawn.isEmpty()){
			SacredPixelDungeon.reportException(new RuntimeException("failed to place all items in a shop!"));
		}
