...
public class VaultGateRoom extends StandardRoom {
	...
	public void paint(Level level) {
		...
		// Decorative corners like AmbitiousImpRoom
		...
		// Quest entrance visuals (same as AmbitiousImpRoom)
		...
		// EXIT tile at center with transition to vault
	...
	// Reuse the same visual classes from AmbitiousImpRoom
