...
import com.sacredpixel.sacredpixeldungeon.sprites.EarthGuardianSprite;
import com.sacredpixel.sacredpixeldungeon.sprites.GhostSprite;
import com.sacredpixel.sacredpixeldungeon.sprites.RatSprite;
import com.sacredpixel.sacredpixeldungeon.sprites.WardSprite;
...
public class SurfaceScene extends PixelScene {
	...
	public void create() {
		...
		int hourOfDay = DateCompat.getHourOfDay();
		boolean dayTime = hourOfDay >= 8 && hourOfDay <= 19;
