...
import com.sacredpixel.sacredpixeldungeon.items.Stylus;
import com.sacredpixel.sacredpixeldungeon.items.TengusMask;
import com.sacredpixel.sacredpixeldungeon.items.Torch;
...
import com.sacredpixel.sacredpixeldungeon.items.bags.PotionBandolier;
import com.sacredpixel.sacredpixeldungeon.items.bags.ScrollHolder;
import com.sacredpixel.sacredpixeldungeon.items.bags.VelvetPouch;
...
import com.sacredpixel.sacredpixeldungeon.items.bombs.Firebomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.FlashBangBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.FrostBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.HolyBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.Noisemaker;
import com.sacredpixel.sacredpixeldungeon.items.bombs.RegrowthBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.ShrapnelBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.SmokeBomb;
import com.sacredpixel.sacredpixeldungeon.items.bombs.WoollyBomb;
import com.sacredpixel.sacredpixeldungeon.items.food.Berry;
import com.sacredpixel.sacredpixeldungeon.items.food.Blandfruit;
import com.sacredpixel.sacredpixeldungeon.items.food.ChargrilledMeat;
import com.sacredpixel.sacredpixeldungeon.items.food.Food;
import com.sacredpixel.sacredpixeldungeon.items.food.FrozenCarpaccio;
...
import com.sacredpixel.sacredpixeldungeon.items.food.PhantomMeat;
import com.sacredpixel.sacredpixeldungeon.items.food.SmallRation;
import com.sacredpixel.sacredpixeldungeon.items.food.StewedMeat;
import com.sacredpixel.sacredpixeldungeon.items.food.SupplyRation;
...
import com.sacredpixel.sacredpixeldungeon.items.quest.CeremonialCandle;
...
import com.sacredpixel.sacredpixeldungeon.items.quest.MetalShard;
import com.sacredpixel.sacredpixeldungeon.items.remains.BowFragment;
import com.sacredpixel.sacredpixeldungeon.items.remains.BrokenHilt;
import com.sacredpixel.sacredpixeldungeon.items.remains.BrokenStaff;
import com.sacredpixel.sacredpixeldungeon.items.remains.CloakScrap;
import com.sacredpixel.sacredpixeldungeon.items.remains.SealShard;
import com.sacredpixel.sacredpixeldungeon.items.remains.TornPage;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.darts.TippedDart;
...
public enum Catalog {
	...
	/**
	 * Resets all catalog data (seen status and use counts).
