...
public class SPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		SacredPixelDungeon.updateSystemUI();
	}
	...
	public static void landscape( boolean value ){
		...
		((SacredPixelDungeon)SacredPixelDungeon.instance).updateDisplaySize();
	}
	...
	public static void systemFont(boolean value){
		// No-op: system font toggle removed from UI
	}

	public static boolean systemFont(){
		return false; // Always use custom fonts (Inter + Noto Sans family)
	}

	public static void setForcePixelFont(boolean value) {
		// No-op
	}

	public static boolean effectiveSystemFont() {
		return systemFont();
	}
	...
	public static boolean vibration(){
		return getBoolean(KEY_VIBRATION, false);
	}
