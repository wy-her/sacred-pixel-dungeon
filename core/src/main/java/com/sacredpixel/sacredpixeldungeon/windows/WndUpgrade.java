...
public class WndUpgrade extends Window {
	...
	public WndUpgrade( Item upgrader, Item toUpgrade, boolean force){
		...
		btnUpgrade.setRect(0, bottom+2*GAP, WIDTH/2f, BTN_HEIGHT);
		add(btnUpgrade);
		addFocusableButton(btnUpgrade);
		...
		btnCancel.setRect(btnUpgrade.right()+1, bottom+2*GAP, WIDTH/2f, BTN_HEIGHT);
		add(btnCancel);
