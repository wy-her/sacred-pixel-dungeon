...
import com.sacredpixel.sacredpixeldungeon.sprites.CrystalGuardianSprite;
...
public class CrystalGuardian extends Mob{
	...
	public boolean isInvulnerable(Class effect) {
		if (recovering){
			...
			return super.isInvulnerable(effect) || (Compat.isAssignableFrom(Char.class, effect) && !Compat.isAssignableFrom(Hero.class, effect) && !Compat.isAssignableFrom(CrystalSpire.class, effect));
		}
