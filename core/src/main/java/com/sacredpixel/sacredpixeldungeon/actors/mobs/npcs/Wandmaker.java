...
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.MassGraveRoom;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.RitualSiteRoom;
import com.sacredpixel.sacredpixeldungeon.levels.rooms.quest.RotGardenRoom;
...
import com.sacredpixel.sacredpixeldungeon.windows.WndWandmaker;
			...
			Game.runOnRenderThread(new Callback() {
				...
				public void call() {
					GameScene.show(new WndQuest(Wandmaker.this, msg1Final){
						@Override
						public void hide() {
							boolean advance = advanceDialog;
							super.hide();
							if (advance) {
								Quest.given = true;
								GameScene.show(new WndQuest(Wandmaker.this, msg2Final));
							}
							//ESC: Quest.given stays false, same dialog appears next time
						}
					});
				}
			});
