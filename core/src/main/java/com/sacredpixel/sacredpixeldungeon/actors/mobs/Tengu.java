...
import com.sacredpixel.sacredpixeldungeon.sprites.TenguSprite;
...
public class Tengu extends Mob {
	...
	public boolean useAbility(){
		...
		while (!abilityUsed){
			...
			if (abilityToUse != lastAbility || Random.Int(10) == 0){
				...
				//count failed reroll as an attempt to avoid excessive looping
				continue;
			}
	...
	public static class ShockerAbility extends Buff {
		...
		public boolean act() {
			...
			//safety check: if target or sprite is invalid, clean up to prevent freeze
