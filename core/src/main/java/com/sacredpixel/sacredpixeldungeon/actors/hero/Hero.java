...
package com.sacredpixel.sacredpixeldungeon.actors.hero;

import com.sacredpixel.sacredpixeldungeon.Assets;
import com.sacredpixel.sacredpixeldungeon.Badges;
import com.sacredpixel.sacredpixeldungeon.Bones;
...
import com.sacredpixel.sacredpixeldungeon.actors.blobs.SacrificialFire;
...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Berserk;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Bless;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Buff;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Charm;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Combo;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Drowsy;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Foresight;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.GreaterHaste;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.HeroDisguise;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.HoldFast;
...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Invulnerability;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Levitation;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.LostInventory;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.MindVision;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Momentum;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.MonkEnergy;
...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Recharging;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Regeneration;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.SnipersMark;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.TimeStasis;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.Vertigo;
...
import com.sacredpixel.sacredpixeldungeon.actors.hero.abilities.duelist.Challenge;
...
import com.sacredpixel.sacredpixeldungeon.actors.hero.abilities.warrior.Endure;
import com.sacredpixel.sacredpixeldungeon.actors.hero.spells.BodyForm;
import com.sacredpixel.sacredpixeldungeon.actors.hero.spells.HallowedGround;
...
import com.sacredpixel.sacredpixeldungeon.effects.CheckedCell;
...
import com.sacredpixel.sacredpixeldungeon.items.Ankh;
import com.sacredpixel.sacredpixeldungeon.items.Dewdrop;
import com.sacredpixel.sacredpixeldungeon.items.EquipableItem;
import com.sacredpixel.sacredpixeldungeon.items.Heap;
import com.sacredpixel.sacredpixeldungeon.items.Heap.Type;
import com.sacredpixel.sacredpixeldungeon.items.Item;
import com.sacredpixel.sacredpixeldungeon.items.KindOfWeapon;
...
import com.sacredpixel.sacredpixeldungeon.items.armor.glyphs.Stone;
...
import com.sacredpixel.sacredpixeldungeon.items.artifacts.CapeOfThorns;
...
import com.sacredpixel.sacredpixeldungeon.items.bags.MagicalHolster;
import com.sacredpixel.sacredpixeldungeon.items.journal.Guidebook;
import com.sacredpixel.sacredpixeldungeon.items.keys.CrystalKey;
import com.sacredpixel.sacredpixeldungeon.items.keys.GoldenKey;
import com.sacredpixel.sacredpixeldungeon.items.keys.IronKey;
import com.sacredpixel.sacredpixeldungeon.items.keys.Key;
import com.sacredpixel.sacredpixeldungeon.items.keys.WornKey;
...
import com.sacredpixel.sacredpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.sacredpixel.sacredpixeldungeon.levels.MiningLevel;
...
import com.sacredpixel.sacredpixeldungeon.levels.rooms.special.WeakFloorRoom;
...
import com.sacredpixel.sacredpixeldungeon.mechanics.ShadowCaster;
...
import com.sacredpixel.sacredpixeldungeon.windows.WndHero;
import com.sacredpixel.sacredpixeldungeon.windows.WndResurrect;
...
public class Hero extends Char {
	...
	// Tracks whether the hero was recently interrupted (e.g. by enemy attack).
	// Prevents onMotionComplete() -> checkKeyHold() from immediately restarting
	// movement after interrupt, which caused the "enemy teleport" bug on HTML5.
	private boolean recentlyInterrupted = false;
	...
	public void busy() {
		...
		//When busy() is called (e.g. from item use callbacks), clear the flag so that
		//Actor.process() can resume and process other actors (like Pushing effects).
	...
	public void interrupt() {
		...
		//On HTML5, if an animation callback was pending (e.g. attack anim),
		//idle() overrides it so the callback will never fire.
		//Clear waitingForCallback so Actor.process can recover immediately.
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			SacredPixelDungeon.switchScene(AlchemyScene.class);
			return false;
	...
	public void damage( int dmg, Object src ) {
		...
		Talent.WarriorFoodImmunity foodBuff = buff(Talent.WarriorFoodImmunity.class);
		if (foodBuff != null){
		...
		// Tutorial: prevent death from damage - keep HP at minimum 1
		if (TutorialManager.isTutorialLevel() && HP - dmg <= 0) {
			dmg = Math.max(0, HP - 1);
		}
	...
	public boolean handle( int cell ) {
		...
		if (!ready) return false; // Block ALL input while not ready
	...
	public void onMotionComplete() {
		// Skip checkKeyHold if interrupted (e.g. by enemy attack/dodge).
		// Without this guard, the held movement key would immediately recreate
		// curAction after interrupt() cleared it, causing the hero to keep
		// moving despite being attacked.
