...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.EnhancedRings;
...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.ScrollEmpower;
import com.sacredpixel.sacredpixeldungeon.actors.buffs.WandEmpower;
...
import com.sacredpixel.sacredpixeldungeon.actors.hero.spells.RecallInscription;
...
public enum Talent {
	...
	public static class WarriorFoodImmunity extends FlavourBuff{
		{ actPriority = MOB_PRIO - 1; }  // Act after mobs, so damage reduction applies first
	}
	...
	public static void onScrollUsed( Hero hero, int pos, float factor, Class<?extends Item> cls ){
		...
		if (hero.hasTalent(RECALL_INSCRIPTION) && Compat.isAssignableFrom(Scroll.class, cls) && cls != ScrollOfUpgrade.class){
			if (hero.heroClass == HeroClass.CLERIC){
	...
	public static void onRunestoneUsed( Hero hero, int pos, Class<?extends Item> cls ){
		if (hero.hasTalent(RECALL_INSCRIPTION) && Compat.isAssignableFrom(Runestone.class, cls)){
			if (hero.heroClass == HeroClass.CLERIC){
				Buff.prolong(hero, RecallInscription.UsedItemTracker.class, hero.pointsInTalent(RECALL_INSCRIPTION) == 2 ? 300 : 10).item = cls;
			} else {
