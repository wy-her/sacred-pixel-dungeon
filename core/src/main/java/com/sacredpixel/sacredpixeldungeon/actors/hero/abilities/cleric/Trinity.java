...
package com.sacredpixel.sacredpixeldungeon.actors.hero.abilities.cleric;
...
import com.sacredpixel.sacredpixeldungeon.actors.hero.spells.MindForm;
import com.sacredpixel.sacredpixeldungeon.actors.hero.spells.SpiritForm;
...
public class Trinity extends ArmorAbility {
	...
	public static class WndItemtypeSelect extends WndTitledMessage {
		...
		public WndItemtypeSelect(HolyTome tome, ClericSpell spell) {
			...
			for (Class<?> cls : discoveredClasses){
				if (Compat.isAssignableFrom(Weapon.Enchantment.class, cls)){
					...
					w.cursedKnown = true;
					options.add(w);
				} else if (Compat.isAssignableFrom(Armor.Glyph.class, cls)) {
					Armor a = new ClothArmor(){
						@Override
						public String name() {
							//for button tooltips
	...
	public static class WndItemConfirm extends WndTitledMessage {
		...
		public WndItemConfirm(Window parentWnd, Item item, HolyTome tome, ClericSpell spell){
			...
			btnConfirm.setRect(0, height+2, width, BTN_HEIGHT);
			add(btnConfirm);
	...
	public static String trinityItemUseText(Class<?> cls ){
		...
		if (Compat.isAssignableFrom(Weapon.Enchantment.class, cls) || Compat.isAssignableFrom(Armor.Glyph.class, cls)) {
