...
import com.sacredpixel.sacredpixeldungeon.sprites.MirrorSprite;
...
public class Feint extends ArmorAbility {
	...
	public static class AfterImage extends Mob {

		{
			...
			//On HTML5/TeaVM, must act AFTER mobs so they can attack it before it fades.
			//Desktop uses threaded actor processing where timing works differently.
			//MOB_PRIO-1 (-21) ensures AfterImage acts after all mobs (MOB_PRIO = -20).
