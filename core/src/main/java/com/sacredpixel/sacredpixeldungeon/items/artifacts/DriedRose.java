...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (SacredPixelDungeon.scene() instanceof GameScene || SacredPixelDungeon.scene() instanceof AlchemyScene)){
	...
	public static class Petal extends Item {
		...
		public boolean doPickUp(Hero hero, int pos) {
			...
			if (rose == null){
				...
				return false;
			} else if ( rose.level() >= rose.levelCap ){
