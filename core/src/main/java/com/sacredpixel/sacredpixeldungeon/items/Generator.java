...
import com.sacredpixel.sacredpixeldungeon.items.armor.ClericArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.ClothArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.DuelistArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.HuntressArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.LeatherArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.MageArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.MailArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.PlateArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.RogueArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.ScaleArmor;
import com.sacredpixel.sacredpixeldungeon.items.armor.WarriorArmor;
...
import com.sacredpixel.sacredpixeldungeon.items.potions.PotionOfHaste;
import com.sacredpixel.sacredpixeldungeon.items.potions.PotionOfHealing;
import com.sacredpixel.sacredpixeldungeon.items.potions.PotionOfInvisibility;
...
import com.sacredpixel.sacredpixeldungeon.items.potions.PotionOfMindVision;
import com.sacredpixel.sacredpixeldungeon.items.potions.PotionOfParalyticGas;
...
import com.sacredpixel.sacredpixeldungeon.items.potions.brews.Brew;
import com.sacredpixel.sacredpixeldungeon.items.potions.elixirs.Elixir;
import com.sacredpixel.sacredpixeldungeon.items.potions.exotic.ExoticPotion;
import com.sacredpixel.sacredpixeldungeon.items.quest.Pickaxe;
...
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfArcana;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfElements;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfEnergy;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfEvasion;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfForce;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfFuror;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfHaste;
...
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfTenacity;
import com.sacredpixel.sacredpixeldungeon.items.rings.RingOfWealth;
...
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfLullaby;
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfMagicMapping;
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfMirrorImage;
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfRage;
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfRecharging;
import com.sacredpixel.sacredpixeldungeon.items.scrolls.ScrollOfRemoveCurse;
...
import com.sacredpixel.sacredpixeldungeon.items.spells.Spell;
import com.sacredpixel.sacredpixeldungeon.items.stones.Runestone;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfAggression;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfAugmentation;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfBlast;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfBlink;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfClairvoyance;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfDeepSleep;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfDetectMagic;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfEnchantment;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfFear;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfFlock;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfIntuition;
import com.sacredpixel.sacredpixeldungeon.items.stones.StoneOfShock;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.ChaoticCenser;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.CrackedSpyglass;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.DimensionalSundial;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.ExoticCrystals;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.EyeOfNewt;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.FerretTuft;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.MimicTooth;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.MossyClump;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.ParchmentScrap;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.PetrifiedSeed;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.RatSkull;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.SaltCube;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.ShardOfOblivion;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.ThirteenLeafClover;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.TrapMechanism;
...
import com.sacredpixel.sacredpixeldungeon.items.trinkets.VialOfBlood;
import com.sacredpixel.sacredpixeldungeon.items.trinkets.WondrousResin;
...
import com.sacredpixel.sacredpixeldungeon.items.wands.WandOfCorrosion;
import com.sacredpixel.sacredpixeldungeon.items.wands.WandOfCorruption;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.AssassinsBlade;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.BattleAxe;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Crossbow;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Cudgel;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Dagger;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Dirk;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Flail;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Gauntlet;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Glaive;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Gloves;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Greataxe;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Greatshield;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Greatsword;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.HandAxe;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Katana;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Longsword;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Mace;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Quarterstaff;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Rapier;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.RoundShield;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.RunicBlade;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Sai;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Scimitar;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Shortsword;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Sickle;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Spear;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Sword;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.WarHammer;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.WarScythe;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.Whip;
import com.sacredpixel.sacredpixeldungeon.items.weapon.melee.WornShortsword;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.ForceCube;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.ThrowingClub;
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.ThrowingHammer;
...
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.ThrowingStone;
import com.sacredpixel.sacredpixeldungeon.items.weapon.missiles.Tomahawk;
...
public class Generator {
	...
	public enum Category {
			...
			for (int i=0; i < values().length; i++) {
				...
				if (subOrdering != null){
					for (int j=0; j < subOrdering.size(); j++){
						if (Compat.isInstance(subOrdering.get(j), item)){
							catResult = i;
							subResult = j;
						}
					}
				} else {
					if (Compat.isInstance(values()[i].superClass, item)) {
						catResult = i;
						subResult = 0;
					}
				}
		...
		static {
			...
			POTION.probs = java.util.Arrays.copyOf(POTION.defaultProbs, POTION.defaultProbs.length);
			...
			SEED.probs = java.util.Arrays.copyOf(SEED.defaultProbs, SEED.defaultProbs.length);
			...
			SCROLL.probs = java.util.Arrays.copyOf(SCROLL.defaultProbs, SCROLL.defaultProbs.length);
			...
			STONE.probs = java.util.Arrays.copyOf(STONE.defaultProbs, STONE.defaultProbs.length);
			...
			WAND.probs = java.util.Arrays.copyOf(WAND.defaultProbs, WAND.defaultProbs.length);
			...
			WEP_T1.probs = java.util.Arrays.copyOf(WEP_T1.defaultProbs, WEP_T1.defaultProbs.length);
			...
			WEP_T2.probs = java.util.Arrays.copyOf(WEP_T2.defaultProbs, WEP_T2.defaultProbs.length);
			...
			WEP_T3.probs = java.util.Arrays.copyOf(WEP_T3.defaultProbs, WEP_T3.defaultProbs.length);
			...
			WEP_T4.probs = java.util.Arrays.copyOf(WEP_T4.defaultProbs, WEP_T4.defaultProbs.length);
			...
			WEP_T5.probs = java.util.Arrays.copyOf(WEP_T5.defaultProbs, WEP_T5.defaultProbs.length);
			...
			MIS_T1.probs = java.util.Arrays.copyOf(MIS_T1.defaultProbs, MIS_T1.defaultProbs.length);
			...
			MIS_T2.probs = java.util.Arrays.copyOf(MIS_T2.defaultProbs, MIS_T2.defaultProbs.length);
			...
			MIS_T3.probs = java.util.Arrays.copyOf(MIS_T3.defaultProbs, MIS_T3.defaultProbs.length);
			...
			MIS_T4.probs = java.util.Arrays.copyOf(MIS_T4.defaultProbs, MIS_T4.defaultProbs.length);
			...
			MIS_T5.probs = java.util.Arrays.copyOf(MIS_T5.defaultProbs, MIS_T5.defaultProbs.length);
			...
			FOOD.probs = java.util.Arrays.copyOf(FOOD.defaultProbs, FOOD.defaultProbs.length);
			...
			RING.probs = java.util.Arrays.copyOf(RING.defaultProbs, RING.defaultProbs.length);
			...
			ARTIFACT.probs = java.util.Arrays.copyOf(ARTIFACT.defaultProbs, ARTIFACT.defaultProbs.length);
			...
			TRINKET.probs = java.util.Arrays.copyOf(TRINKET.defaultProbs, TRINKET.defaultProbs.length);
	...
	public static void reset(Category cat){
		if (cat.defaultProbs != null) {
			if (cat.defaultProbs2 != null){
				...
				cat.probs = cat.using2ndProbs ? java.util.Arrays.copyOf(cat.defaultProbs2, cat.defaultProbs2.length) : java.util.Arrays.copyOf(cat.defaultProbs, cat.defaultProbs.length);
			} else {
				cat.probs = java.util.Arrays.copyOf(cat.defaultProbs, cat.defaultProbs.length);
			}
		}
	}
	...
	public static void undoDrop(Class cls){
		for (Category cat : Category.values()){
			if (Compat.isAssignableFrom(cls, cat.superClass)){
