...
public class UnstableSpellbook extends Artifact {
	...
	private void setupScrolls(){
		...
		float[] probs = java.util.Arrays.copyOf(Generator.Category.SCROLL.defaultProbsTotal, Generator.Category.SCROLL.defaultProbsTotal.length); //array of primitives, clone gives deep copy.
