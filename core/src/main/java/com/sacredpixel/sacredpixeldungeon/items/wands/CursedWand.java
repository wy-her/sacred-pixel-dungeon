...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.GravityChaosTracker;
...
import com.sacredpixel.sacredpixeldungeon.actors.buffs.SuperNovaTracker;
...
import com.sacredpixel.sacredpixeldungeon.actors.mobs.npcs.NPC;
...
import com.sacredpixel.sacredpixeldungeon.effects.particles.PitfallParticle;
...
import com.sacredpixel.sacredpixeldungeon.items.scrolls.exotic.ScrollOfSirensSong;
		...
		public boolean effect(Item origin, Char user, Ballistica bolt, boolean positiveOnly) {
			...
			try {
				...
				if(Messages.lang() != Languages.ENGLISH){
					...
					SacredPixelDungeon.runOnRenderThread(
							new Callback() {
								@Override
								public void call() {
									GameScene.show(
