...
public class Statistics {
	...
	public static boolean ratKingAwoken = false;
	...
	private static final String COMPLETED_NO_KILLING	= "completed_no_killing";
	...
	private static final String RAT_KING_AWOKEN = "ratKingAwoken";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put(COMPLETED_NO_KILLING, completedWithNoKilling);
		...
		bundle.put( RAT_KING_AWOKEN, ratKingAwoken );
	}
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		completedWithNoKilling = bundle.getBoolean( COMPLETED_NO_KILLING );
		...
		ratKingAwoken   = bundle.getBoolean( RAT_KING_AWOKEN );
	}
